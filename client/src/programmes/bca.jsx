...
function HeroSection() {
  return (
    <section className="hero-section">
      <img src="mnnit_adm_building.jpeg" alt="BCA Image" />
      <div className="hero-text">Bachelor of Computer Applications</div>
    </section>
  );
}
  ...
  return (
    <section className="semesters-section">
      <div className="grid">
        ...
        <SemesterButton semester="Semester 5" />
        <SemesterButton semester="Semester 6" />
      </div>
    </section>
  );
}
